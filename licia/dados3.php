...
<html lang="pt-br">
    <head>
        <title> Avaliação da Integradra Licia </title>
        <meta charset="utf-8">
   ...
   <?php 
    ...
    ?>
      ...
      ?>
                <div class="col-sm-10">
            <h1>Avaliação da Integradora </h1>
            <p> Importação do Questionario </p> 
...
//                if ( isset( $_POST['Submit'] ) ) {
    ...
    move_uploaded_file($_FILES['arquivo']['tmp_name'], $uploadfile); //Fazer upload do arquivo
                    ...
                    require_once './Classes/functions_avalia.php';
                    $gravaBd = new avaliacao();
...
//                            $nota20 = $teste2[22] == 'ü' ? 1 : 0;
                            ...
                            if($chaca_notas == NULL){
                              ...
                              $insert = $gravaBd->insert($nomeAluno, $matricula2, $codgo, $data_insert, $date_updat, $periodoLetivo, $nota1, $nota2, $nota3, $nota4, $nota5, $nota6, $nota7, $nota8, $nota9, $nota10, $nota11, $mutiplicado,$turma_curso );
                              echo $insert;
                          //  $rs_notas = pg_query($bd_licia, $insert) or die("Erro ao inserir notas da integradora!! " . $insert);  
                                
                            } else {
                            
                                $update = $gravaBd->update($id,$nomeAluno, $matricula2, $codgo, $data_insert, $date_updat, $periodoLetivo, $nota1, $nota2, $nota3, $nota4, $nota5, $nota6, $nota7, $nota8, $nota9, $nota10, $nota11, $mutiplicado,$turma_curso );
